# `Arpack32_jll.jl` (v3.9.1+0)

[![deps](https://juliahub.com/docs/Arpack32_jll/deps.svg)](https://juliahub.com/ui/Packages/General/Arpack32_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/37e28264dd8cb1573df1a944d922d10fee39e027/A/Arpack/Arpack32/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `Arpack32_jll.jl` have been built from these sources:

* git repository: https://github.com/opencollab/arpack-ng.git (revision: `40329031ae8deb7c1e26baf8353fa384fc37c251`)

## Platforms

`Arpack32_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `Arpack32_jll.jl`:
